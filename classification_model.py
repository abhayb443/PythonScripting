...
data_dir = "/home/abhay/Desktop/Dataset/RealandFake/real_and_fake_face"
...
"""Here are some real images:"""
import re

pattern_real = r'training_real'
real = list(filter(lambda v: re.findall(pattern_real, v), data_list))

# print(len(real))

# PIL.Image.open(str(real[0]))
# PIL.Image.open(str(real[1]))

# """And some fake images:"""

pattern_fake = r'training_fake_pics'
fake = list(filter(lambda v: re.findall(pattern_fake, v), data_list))

# print(len(fake))

# PIL.Image.open(str(fake[0]))
# PIL.Image.open(str(fake[1]))
...
# """## Predict on new data
#
# Finally, let's use our model to classify an image
# that wasn't included in the training or validation sets.
#
